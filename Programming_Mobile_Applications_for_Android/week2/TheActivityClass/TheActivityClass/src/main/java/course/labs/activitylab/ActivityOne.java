...
public class ActivityOne extends Activity {
	...
	private String countersKeyName = "counters";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
		    mCounter = savedInstanceState.getIntArray(countersKeyName);
		}

        Log.d(TAG, CREATE_KEY + " called");


        Integer index = ActivityOne.mapping.get(new Object(){}.getClass().getEnclosingMethod().getName());
		mCounter[index] += 1;
	...
	public void onSaveInstanceState(Bundle savedInstanceState) {
		savedInstanceState.putIntArray(countersKeyName, mCounter);
	}
